...
//    printf("Number of textures are: %d\n", numtextures);
    fprintf(stdout, "Info: GLM: glmSecondPass: Number of vertices are: %d\n", numvertices);
    fprintf(stdout, "Info: GLM: glmSecondPass: Number of textures are: %d\n", numtextures);
}
...
glmReadOBJ(const char* filename)
{
    ...
    if (!file) {
        fprintf(stderr, "Error: GLM: glmReadOBJ: Can't open data file \"%s\".\n", filename);
        exit(EXIT_FAILURE);
    }
